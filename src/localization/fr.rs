...
pub fn text(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::Show16BitTasks => "Afficher les tâches &16 bits",
        TextKey::NoTitle => "&Sans titre",
        ...
        TextKey::Tasks => "Applications",
        TextKey::Processes => "Processus",
        TextKey::Users => "Utilisateurs",
